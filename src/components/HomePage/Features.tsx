...
const features = [
  {
    ...
    description:
      "These files include all the design elements, layouts, and assets used in the HTML Template, allowing for customization.",
  },
  {
    image: "https://i.ibb.co.com/7dPVWvz9/features2.png",
    title: "Fast & Friendly Support",
    description:
      "No need to manually create pages or configure settings. Your site will look like the demo in minutes.",
  },
  {
    image: "https://i.ibb.co.com/R40XSxrx/features3.png",
    title: "Top Notch Performance",
    description:
      "A high-performing theme is crucial for retaining visitors, improving search engine rankings, and enhancing overall site performance.",
  },
];

export default function FeaturesSection() {
  return (
    <section className="container mx-auto relative bg-[radial-gradient(circle_at_bottom,rgba(10,10,20,1)_0%,rgba(5,5,10,1)_40%,rgba(0,0,0,1)_100%)] text-white pt-16 md:pt-28 pb-24 md:pb-44 overflow-hidden">
