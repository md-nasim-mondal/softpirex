  ...
  return (
    <section className="relative bg-[#3F51B5] text-white py-16 px-6">
      ...
      <p className="text-white uppercase mb-4 text-center">Build With Incredible</p>
        <h2 className=" md:text-6xl font-bold leading-tight w-full lg:w-[660px] mx-auto text-center mb-6">Responsive & Retina Ready Template</h2>
        ...
        <div className="relative flex justify-center mt-10 top-24">
          <div className="relative w-[800px] h-auto">
            <Image src="https://i.ibb.co.com/nHcyfYc/devixa-agency-template-banner-wxrbll-S.webp" alt="Responsive Design" width={900} height={600} className="rounded-lg" />
          </div>
        </div>
      </div>
    </section>
