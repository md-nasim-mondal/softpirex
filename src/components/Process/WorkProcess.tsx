...
const WorkProcess: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      number: "02",
      title: "Strategy",
      content: `We unearth valuable insights that inform strategic decisions, guiding
  ...
  return (
    <section className="text-white py-12 md:py-24 px-8">
      <div className=" flex justify-between flex-col md:flex-row">
        <div>
          <h2 className="text-4xl md:text-6xl font-bold">Our work Process</h2>
        ...
        <div className="w-full md:w-3/4">
          {steps.map((step, index) => (
            <div key={index} className="border-b border-gray-300  py-4 ">
              ...
              >
                <div>
                  <span className="text-[#3F51B5] text-3xl font-bold mr-2">
                    {step.number}
                  </span>
                  <span className="text-3xl font-semibold mr-5">
                    {step.title}
                  </span>
                </div>
